            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-2">
                        <a href="{{url('/user/create')}}" class="btn btn-primary btn-block">Add</a>
                    </div>
                    <div class="form-group col-lg-2">
                        <a href="{{url('/user')}}" class="btn btn-info btn-block">Reset</a>
                    </div>
                    <div class="form-group col-lg-2">
                        ...
                        <table class="table table-hover table-striped table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th onclick="sortBy('first_name')" class="c--pointer" scope="col"><i class="fas fa-sort"></i> Name</th>
                                    <th onclick="sortBy('email')" class="c--pointer" scope="col"><i class="fas fa-sort"></i> Email</th>
                                    <th>Role</th>
                                    <th onclick="sortBy('created_at')" class="c--pointer" scope="col"><i class="fas fa-sort"></i> Created</th>
                                ...
                                @forelse ($users as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('/user/edit/'.$item->id)}}" class="text-warning" title="Edit">
                                                <span>
...
<script>
    ...
    var app_url = @JSON(env('APP_URL').'/user?page=1');
