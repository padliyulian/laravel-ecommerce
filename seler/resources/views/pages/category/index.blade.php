            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-2">
                        <a href="{{url('/category/create')}}" class="btn btn-primary btn-block">Add</a>
                    </div>
                    <div class="form-group col-lg-2">
                        <a href="{{url('/category')}}" class="btn btn-info btn-block">Reset</a>
                    </div>
                    <div class="form-group col-lg-2">
                        ...
                        <table class="table table-hover table-striped table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th onclick="sortBy('slug')" class="c--pointer" scope="col"><i class="fas fa-sort"></i> Slug</th>
                                    <th onclick="sortBy('parent_id')" class="c--pointer" scope="col"><i class="fas fa-sort"></i> Parent</th>
                                ...
                                @forelse ($categories as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('/category/edit/'.$item->id)}}" class="text-warning" title="Edit">
                                                <span>
...
<script>
    ...
    var app_url = @JSON(env('APP_URL').'/category?page=1');
