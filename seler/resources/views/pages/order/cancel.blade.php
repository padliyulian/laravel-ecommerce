            ...
            <div class="col-lg-6">
                <div class="card card-default">
                    <div class="card-header card-header-border-bottom">
                        <h2 class="card-title">Cancel Order #{{ $order->code }}</h2>
                    ...
                    <div class="card-body">
                        {!! Form::model($order, ['url' => ['orders/cancel', $order->id], 'method' => 'PATCH']) !!}
                        {!! Form::hidden('id') !!}
                        <div class="form-group">
                            <label for="cancellation_note">Cancellation Note</label>
                            <input type="text" class="form-control @error('cancellation_note') is-invalid @enderror" name="cancellation_note" value="{{ old('cancellation_note') ?? $order->cancellation_note }}" id="cancellation_note">
                        ...
                        <div class="form-footer pt-5 border-top">
                            ...
                            <a href="{{ url('orders') }}" class="btn btn-secondary btn-default">Back</a>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>  
