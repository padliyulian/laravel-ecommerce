        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('/product/attribute/'.$attribute->id)}}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="form-group col-12 col-lg-6">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ $attribute->code }}" placeholder="Code">
                                    @error('code')
                                ...
                                <div class="form-group col-12 col-lg-6">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $attribute->name }}" placeholder="Name">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-12 col-lg-6">
                                    <select name="type" class="form-control @error('type') is-invalid @enderror">
                                        ...
                                        @foreach ($types as $key => $val)
                                            <option value="{{$key}}" {{$attribute->type == $key ? 'selected':''}}>{{$val}}</option>
                                        @endforeach
                                    </select>
                                    @error('type')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group col-12 col-lg-6">
                                    <select name="is_required" class="form-control @error('is_required') is-invalid @enderror">
                                        ...
                                        @foreach ($booleanOptions as $key => $val)
                                            <option value="{{$key}}" {{$attribute->is_required == $key ? 'selected':''}}>{{$val}}</option>
                                        @endforeach
                                    </select>
                                    @error('is_required')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-lg-6">
                                    <select name="is_unique" class="form-control @error('is_unique') is-invalid @enderror">
                                        ...
                                        @foreach ($booleanOptions as $key => $val)
                                            <option value="{{$key}}" {{$attribute->is_unique == $key ? 'selected':''}}>{{$val}}</option>
                                        @endforeach
                                    </select>
                                    @error('is_unique')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group col-12 col-lg-6">
                                    <select name="validation" class="form-control @error('validation') is-invalid @enderror">
                                        ...
                                        @foreach ($validations as $key => $val)
                                            <option value="{{$key}}" {{$attribute->validation == $key ? 'selected':''}}>{{$val}}</option>
                                        @endforeach
                                    </select>
                                    @error('validation')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-lg-6">
                                    <select name="is_configurable" class="form-control @error('is_configurable') is-invalid @enderror">
                                        ...
                                        @foreach ($booleanOptions as $key => $val)
                                            <option value="{{$key}}" {{$attribute->is_configurable == $key ? 'selected':''}}>{{$val}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-12 col-lg-6">
                                    <select name="is_filterable" class="form-control @error('is_filterable') is-invalid @enderror">
                                        ...
                                        @foreach ($booleanOptions as $key => $val)
                                            <option value="{{$key}}" {{$attribute->is_filterable == $key ? 'selected':''}}>{{$val}}</option>
                                        @endforeach
                                    </select>
                                    @error('is_filterable')
                                        <span class="invalid-feedback" role="alert">
