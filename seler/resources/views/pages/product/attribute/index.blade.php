            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-lg-2">
                        <a href="{{url('/product/attribute/create')}}" class="btn btn-primary btn-block">Add</a>
                    </div>
                    <div class="form-group col-lg-2">
                        <a href="{{url('/product/attribute')}}" class="btn btn-info btn-block">Reset</a>
                    </div>
                    <div class="form-group col-lg-2">
                        ...
                        <table class="table table-hover table-striped table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th onclick="sortBy('code')" class="c--pointer" scope="col"><i class="fas fa-sort"></i> Code</th>
                                ...
                                @forelse ($attributes as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('/product/attribute/option/'.$item->id)}}" class="text-info" title="Options">
                                                <span>
                                                    <i class="fas fa-cogs" aria-hidden="true"></i>
                                                </span>
                                            </a>
                                            <a href="{{url('/product/attribute/edit/'.$item->id)}}" class="text-warning" title="Edit">
                                                <span>
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                </span>
                                            </a>
                                            <form action="{{url('/product/attribute/'.$item->id)}}" method="POST" class="d-inline">
                                                @csrf
                                                @method("DELETE")
...
<script>
    ...
    var app_url = @JSON(env('APP_URL').'/product/attribute?page=1');
